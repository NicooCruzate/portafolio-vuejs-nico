...
const title = 'Nicolás Emanuel Cruzate';
...
<template>
  <section class="datos-personales">
    ...
    <div class="card">
      ...
      <p>{{ presentacion }}</p>
      <ul class="example-2">
        <li class="icon-content" v-for="red in redesSociales" :key="red.id">
          <a :href="red.url" :data-social="red.name" aria-label="red.name">
            <div class="filled"></div>
            <img class="icon-redsocial" :src="red.src" width="25" :alt="red.name" />
          </a>
        </li>
      </ul>
...
/* Paleta de colores */
.datos-personales {
  --color-primary: #B0003A ;   /* Azul oscuro suave */
  --color-secondary: #B0003A ; /* Morado pastel */
  --color-tertiary: #B0003A ;  /* Lavanda claro */
  --color-quaternary: #B0003A ; /* Rosa pastel */
  --color-accent: #B0003A ;    /* Fondo claro */
}
...
.icon-content a .filled {
  ...
  width: 100%;
  height: 0;
  border-radius: 50%; /* Hace el efecto redondeado */
...
.icon-content a[data-social="curriculum"] .filled {
